...
@EnableFeignClients
public class OrderServiceConsumerSentinelFlowlimtPersistenceLoadBalanceOpenFeignConfiguration80 {
    public static void main(String[] args) {
        SpringApplication.run(OrderServiceConsumerSentinelFlowlimtPersistenceLoadBalanceOpenFeignConfiguration80.class, args);
    }
}
